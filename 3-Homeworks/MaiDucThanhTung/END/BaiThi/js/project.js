  ...
  let res = `
      ...
      <table id="table_users" class="table table-dark table-striped">
          ...
          <tbody>
            ...
            <a class="btn btn-success" href="./form.html">Create</a>
            </table>
        </div>`;
...
function getListUsers() {
  fetch("https://63758f5b48dfab73a4fb0332.mockapi.io/project", {
    method: "GET",
  })
...
function deleteUser(id) {
  ...
  fetch("https://63758f5b48dfab73a4fb0332.mockapi.io/project/" + id, {
    method: "DELETE",
  })
    .then((response) => response.json())
    .then((data) => {
